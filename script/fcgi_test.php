...
echo "resp: start\n";
file_put_contents("php://stderr",“aaaaaaaaaa”);
var_dump(http_response_code(400));

// print_r($GLOBALS,1)."\n".print_r($_SERVER,1)."\n";
echo "GLOBALS is:\n";
file_put_contents("/Users/johntech/code/gocode/src/github.com/peppertree/log/access.log","request arrive".$_SERVER['key']."\n",FILE_APPEND);
// print_r($GLOBALS);
// echo "SERVER is:\n";
// print_r($_SERVER);
// var_dump($_SERVER);
